...
export default async function TrainingPageContent() {
  ...
  const externalCertCta = await loadExternalCertificateCtaState(supabase, user.id);
  ...
  return (
    <TrainingCommandLanding
      ...
      showExternalCertPrompt={externalCertCta.show}
      externalCertPendingReview={externalCertCta.pendingReview}
