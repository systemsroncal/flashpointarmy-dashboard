...
export const MOBILIZE_ALERTS_HREF = `${MOBILIZE_PREFIX}/notifications`;
export const MOBILIZE_MESSAGES_HREF = `${MOBILIZE_PREFIX}/notifications`;
export const MOBILIZE_BOOKMARKS_HREF = `${MOBILIZE_PREFIX}/bookmarks`;
export const MOBILIZE_SOCIAL_SETTINGS_HREF = `${MOBILIZE_PREFIX}/settings`;
